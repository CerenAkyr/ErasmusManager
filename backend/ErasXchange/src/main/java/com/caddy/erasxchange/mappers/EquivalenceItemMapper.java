...
public interface EquivalenceItemMapper {
    @Mapping(source = "bilkentCourseCode", target = "bilkentCourse")
    @Mapping(source = "externalCourseCode", target = "externalCourse")
    EquivalenceItem toEntity(EquivalenceItemDto equivalenceItemDto);

    @Mapping(source = "externalCourse.courseCode", target = "externalCourseCode")
    @Mapping(source = "bilkentCourse.courseCode", target = "bilkentCourseCode")
